...
num_doctors_label = tk.Label(header_frame, text=f"Number of Patient: {num_patients}", font=("Ariel", 14))
num_doctors_label.pack(side=tk.TOP)

# Create the label for the number of nurses
num_nurses_label = tk.Label(header_frame, text=f"Total Number of Appointments: {num_appointments}", font=("Ariel", 14))
...
def print_selected_data(event):
    ...
    s = 'python3 Patient_Dets.py '+ str(strn)
    os.system(s) 
